...
CUB_path = '/scratch/x956c659/data/fewShot/CUB/CUB'
...
if __name__ == '__main__':
    ...
    # Load attributes
    attrs = pd.read_csv(CUB_path +'/attributes/image_attribute_labels.txt',
                        sep=' ',
                        header=None,
    ...
    # Get image names
    image_names = pd.read_csv(CUB_path +'/images.txt', sep=' ',
                              header=None,
